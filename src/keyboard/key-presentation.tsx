...
function bluetoothLabel(binding: BehaviorBinding): string {
  switch (binding.param1) {
    case 0: return "CLR";
    case 1: return "NXT";
    case 2: return "PRV";
    case 3: return String(binding.param2);
    case 4: return "ALL";
    default: return `?${binding.param1}`;
  }
}
...
export function getNonTransparentBindingLabel(
  ...
  switch (displayName) {
    ...
    case "Mod-Tap":
      return `${formatModifierKeycode(binding.param1)}+${hidParamLabel(binding.param2)}`;
    case "Hold-Tap":
      return hidParamLabel(binding.param2);
    ...
    case "Sticky Key":
      return `Sticky ${formatModifierKeycode(binding.param1)}`;
    ...
    case "Bluetooth":
      return `BT ${bluetoothLabel(binding)}`;
    case "None":
      return "無効";
    default:
      return displayName;
...
function keyDisplay(binding: BehaviorBinding, displayName: string, layers: readonly LayerName[]): { header: string; children: ReactNode } {
  switch (displayName) {
    ...
    case "Mod-Tap": return { header: formatModifierKeycode(binding.param1), children: <span>{hidParamLabel(binding.param2)}</span> };
    ...
    case "Sticky Key": return { header: "Sticky", children: <span>{formatModifierKeycode(binding.param1)}</span> };
    ...
    case "Bluetooth": return { header: "BT", children: <span>{bluetoothLabel(binding)}</span> };
