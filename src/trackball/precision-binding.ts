...
export function analyzePrecisionBinding(
  ...
  if ((displayName === "Layer-Tap" || displayName === "LAYER_TAP_MKP" || displayName === "&lt" || displayName === "&lt_mkp") && binding.param1 === PRECISION_LAYER_INDEX) {
