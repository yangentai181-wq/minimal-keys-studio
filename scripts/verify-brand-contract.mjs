...
export function findBrandContractViolations(root) {
  ...
  const packageLock = json(root, "package-lock.json");
  ...
  equal(packageLock.version, packageJson.version, "Package lock version");
  equal(packageLock.packages?.[""]?.version, packageJson.version, "Package lock root version");
